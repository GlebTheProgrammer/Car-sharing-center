# SamSolutions Project - Car Sharing Center (На момент 26 ноября 2022 г.)
...
- Ну и много разных фич, как всплывающие уведомления (`SweetAlert2`), информация об ошибках, подключение к сторонним сервисам (`google maps API`, тот же самый `Stripe`) и др.
...
### Страницы с редактированием информации активного пользователя и его активных автомобилей
...
При нажатии, пользователю открывается страница, на которой он сможет менять любую информацию, что отображена на странице

![2](https://user-images.githubusercontent.com/55713244/204080997-bd52eb58-3d2c-4654-b9a6-6ec9ca55a91b.jpg)

p.s. Часть ниже будет доработана сегодня вечером, а именно (страницы редактирования информации, страница оформления заказов, UI Stripe + возможно, руководство по отслеживанию и мониторинга заказов).
