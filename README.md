# SamSolutions Project - Car Sharing Center (1 марта 2023 г.)
...
- 13 марта 2023 - Работа над анализатором server response на клиентской стороне и настройка универмального обработчика этих responses.
...
В данном разделе максимально подробно объясняется, как что работает, почему была выбрана именно такая стратегия, какие трудности были преодолены и вообще, что как работает и устроено.
